def print_description():
    print("\n\033[1;33mK-NEAREST NEIGHBOR CLASSIFICATION ALGORITHM - GENERATE TRAIN & TEST DATASETS\033[0m\n\n"
        "------------------------------------------------------------\n"
        "\033[1;31mIt seems you did not pass all the required parameters to generate the train and test datasets. \033[0m\n\n"
        ...
        "\t - Number of features for each sample \033[;32m[n_features]\033[0m\n"
